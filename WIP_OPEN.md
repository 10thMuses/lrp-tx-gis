...
- Layer count: **24**
- Last published deploy: `69ee76fc43cd26b6f3460922` (Chat 107c, 2026-04-26). State=ready. Contrast/legibility/fuel pass on top of 107a: dark text-halo (`#0f172a` width 1.5) for label visibility against satellite; default line width 1 → 0.5 (transmission scaling 0.75-2 → 0.4-1.25); high-contrast neon palette overhaul — eia860_plants `#22d3ee` cyan, eia860_battery `#f472b6` pink, solar `#facc15`, transmission `#38bdf8`, substations `#a78bfa` violet, tpit_subs+tpit_lines `#06b6d4` teal, rrc_pipelines `#fb7185` rose, tceq_gas_turbines `#f0abfc` magenta, tax_abatements `#ef4444`, dc_anchors `#fbbf24`, bts_rail `#94a3b8`, labels_hubs `#fef3c7` cream; explicit `line_width: 0.5` on counties, tpit_lines, rrc_pipelines, tiger_highways, bts_rail; EIA-860 fuel codes relabeled in build pipeline (NG → Natural Gas (NG), 26 codes total) so filters show full names with abbrev in parens. Build clean: `built=24 missing=0 errored=0 tiles_total=12712 KB`. Deploy delta: 2 files (index.html + 1 tile, eia860_plants — fuel relabel changed its features).
