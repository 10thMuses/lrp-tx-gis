...
.stat-big {{ font-size: 14.5pt; white-space: nowrap; font-weight: 700; color: {NAVY}; margin: 0.6mm 0; }}
...
em {{ color: #3a4656; }}
img {{ width: 100%; margin: 2mm 0 4mm; page-break-inside: avoid; }}
h1 + p em, h2:first-of-type + p em {{ font-size: 10.5pt; }}
"""

fc = FontConfiguration()
os.makedirs(os.path.dirname(OUT), exist_ok=True)
HTML(string=f"<html><body>{body}</body></html>", base_url="/home/claude/crusoe/").write_pdf(OUT, stylesheets=[CSS(string=css, font_config=fc)], font_config=fc)
print("written", OUT)
